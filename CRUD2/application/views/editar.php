      ...
      <div class="box">
        ...
        <div class="box-body">
         ...
         <div class="box box-warning">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                <form action="<?php echo site_url('Datos/editar/'.$id);?>" method="POST" role="form" >
                    ...
                    <div class="form-group <?php echo (form_error('celular')==null)?'':'has-error';?>">
                      <label>gustos</label>
                      <input name="gustos" type="text" class="form-control" placeholder="Enter celular..." value="<?php echo set_value('gustos',$informa['gustos'])?>">
                   ...
                   <!-- <div class="form-group"> -->
                    <!--  <label>gustos</label> -->
                    <!--  <select name="gustos" class="form-control"> -->
                    <!--    <option value=""></option> -->
