                                  ...
                                  <form action="" method="POST">
                                    <?php echo validation_errors(); ?>
                                      ...
                                      <div class="form-group <?php echo ( form_error('nombre')==null  )?'':'has-error';?>">                                         
                                            <label>nombre</label>
                                            <input name="nombre" type="text" class="form-control" placeholder="Enter ..." value="<?php echo set_value('nombre') ?>"/>
                                      ...
                                      <div class="form-group <?php echo(form_error('telefono')==null)?'':'has-error';  ?> ">
                                            ...
                                            <input name="telefono" type="text" class="form-control" placeholder="Enter ..." value="<?php echo set_value('telefono') ?>"/>
                                     ...
                                     <div class="form-group <?php echo ( form_error('celular')==null  )?'':'has-error';?>">
                                            <label>celular</label>
                                            <input  name="celular"type="text" class="form-control" placeholder="Enter ..." value="<?php echo set_value('celular') ?>"/>
                                     ...
                                     <div class="form-group <?php echo ( form_error('correo')==null  )?'':'has-error';?>">
                                            <label>correo</label>
                                            <input name="correo" type="text" class="form-control" placeholder="Enter ..." value="<?php echo set_value('correo') ?>"/>
                                     ...
                                     <div class="form-group <?php echo ( form_error('direccion')==null  )?'':'has-error';?>">
                                            ...
                                            <input name="direccion" type="text" class="form-control" placeholder="Enter ..." value="<?php echo set_value('direccion') ?>"/>
                                     ...
                                     <div class="form-group <?php echo ( form_error('pasatiempo')==null  )?'':'has-error';?> ">
                                            ...
                                            <textarea  name="pasatiempo" class="form-control" rows="3" placeholder="Enter ..."><?php echo set_value('pasatiempo') ?></textarea>
                                     ...
                                     <div class="form-group <?php echo ( form_error('pais')==null  )?'':'has-error';?>">
                                            ...
                                            <select   name="pais"class="form-control">
                                                ...
                                                <option value="<?php echo $listaPaises['ID'] ?>" <?php echo set_select('pais',$listaPaises['ID']);  ?> ><?php echo $listaPaises['pais'] ?> </option>
                                                <?php } ?>
                                                <?php echo '<label class="control-label" for="inputError"><i></i>'. form_error('pais').'</label>'; ?>
                                            </select>
                                        </div>
