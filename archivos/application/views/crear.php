            ...
            <div class="box box-warning">
                ...
                <?php $attributes = array('autocomplete' => 'off'); echo form_open_multipart('Datos/crear',$attributes);?>
                        ...
                        <div class="form-group <?php echo (form_error('correo') == null) ? '' : 'has-error'; ?>">
                            <label>correo</label>
                            <input name="correo" type="text" class="form-control" placeholder="Enter correo..." value="<?php echo set_value('correo') ?>">
                            <?php echo '<span class="help-block">' . form_error('correo') . '</span>'; ?>
                        </div>

                        <div class="form-group <?php echo (form_error('pasword') == null) ? '' : 'has-error'; ?>">
                            <label>pasword</label>
                            <input name="pasword" type="text" class="form-control" placeholder="Enter pasword..." value="<?php echo set_value('pasword') ?>">
                            <?php echo '<span class="help-block">' . form_error('pasword') . '</span>'; ?>
                        </div>
                        
                        <div class="form-group <?php echo (form_error('foto') == null) ? '' : 'has-error'; ?>">
                            <label>foto</label>
                            <input name="foto" type="file" class="form-control" placeholder="Enter pasword..." value="<?php echo set_value('foto') ?>">
